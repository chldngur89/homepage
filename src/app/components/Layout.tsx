        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><Link to="/about" className="hover:text-cyan-400 transition-colors">회사소개</Link></li>
                <li><Link to="/contact" className="hover:text-cyan-400 transition-colors">문의하기</Link></li>
                <li><a href="#" className="hover:text-cyan-400 transition-colors">채용</a></li>
                <li><a href="#" className="hover:text-cyan-400 transition-colors">언론보도</a></li>
              </ul>
            </div>
          </div>
