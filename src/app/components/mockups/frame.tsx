...
export function MockFrame({
  ...
  return (
    <div
      className={`mock-frame w-full overflow-hidden rounded-[14px] border border-line-2 bg-surface shadow-[0_1px_2px_rgba(0,0,0,.04),0_8px_24px_rgba(0,0,0,.04)] ${className}`}
      style={{ "--mock-ratio": ratio } as CSSProperties}
    >
