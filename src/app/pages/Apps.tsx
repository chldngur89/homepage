...
const iconByAppId: Record<string, React.ReactNode> = {
  ...
  "aircon-call": <img src="/apps/aircon-call-icon-card2.png" alt="" className="h-full w-full object-contain" />,
};
...
const specialCardStyles = {
  ...
  "aircon-call": {
    ...
    iconClass: "w-16 h-16 rounded-[1.35rem] bg-white shadow-[0_12px_28px_rgba(255,255,255,0.12)]",
      ...
      <section className="max-w-7xl mx-auto px-6 mb-16">
        ...
        >
          ...
          <p className="text-xl text-slate-400 max-w-3xl mx-auto">
            {siteContent.appsPage?.description ?? "Marketing OS 앱 AutoCMO, 에어컨콜, CEO Rader AI, CFO Tool on AI, LowestAlert AI, PMS on AI까지 웹에서 바로 사용하거나 새 탭에서 열어보세요."}
          </p>
        </motion.div>
      </section>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-2 flex-wrap">
                  <h2 className={`text-xl font-bold break-words ${titleClass}`}>{app.name}</h2>
                  {specialStyles && (
                    <span className={`px-2 py-0.5 rounded-md text-xs font-medium ${specialStyles.badgeClass}`}>CTO 활동</span>
                  )}
                </div>
